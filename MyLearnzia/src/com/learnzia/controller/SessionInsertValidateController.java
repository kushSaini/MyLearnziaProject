...
@WebServlet("/SessionInsertValidateController")
public class SessionInsertValidateController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(name!=false) {
			request.getRequestDispatcher("insertSession.jsp").forward(request, response);
		}
		else {
