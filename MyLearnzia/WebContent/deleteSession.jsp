			...
			<div class="bg-contact2"
				...
				<div class="container-contact2">
					<div class="wrap-contact2">
						<form class="contact2-form validate-form"  action="SessionDeleteController" method="POST">
						<span class="contact2-form-title"> Delete Session </span>
						
							<label>Enter Session ID To Delete</label>
