      ...
      <div class="modal-content">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                ...
                <div class="ml-5 mt-5">
                <iframe src="https://docs.google.com/presentation/d/1DIqmjoNmyA4F06Xtf1jXgt7Ju3sgdSbdP1cKkTvmB8w/embed?start=false&loop=false&delayms=3000" frameborder="0" width="960" height="749" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
                <br><h2><b>JIRA</b></h2><hr size="4" color="black">
                <h3>About JIRA</h3><br><br>
                <p><b>
                Jira Software is based on the Jira Core platform. In that way, on Jira Software, you'll be provided with all the Jira Core functionality but you'll be provided with additional agile features.
				Jira Software supports any agile project management methodology for software development, such as:<br>
                <br>
                * The ability to plan agile work from project backlog to sprints<br>
				* Fully customizable Kanban and Scrum boards<br>
				* The ability to estimate time for issues as you prioritize your backlog<br>
				* Robust reporting features, ranging from burndown charts to velocity measurements<br>
				* Customizable workflows to fit your frameworks
                </b></p><br><br>
                <h4><b>Presentation Credit :</b> Muskan Ojha :)</h4>
                </div>
                <div class="content">
                    <div class="container-fluid">
                        <div class="section">
