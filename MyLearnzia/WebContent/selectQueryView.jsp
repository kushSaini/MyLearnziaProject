    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="main-panel">
           ...
           <div align="center">
<h1>All-Queries</h1><hr color="blue" size="4">
<table border="1">
<tr><th>Query ID </th><th>Query </th><th>Query Language</th></tr>
<c:forEach var="i" items="${requestScope.list}">
	<tr><td><c:out value="${i.queryId}"/></td><td><c:out value="${i.queryName}"/></td>
	<td><c:out value="${i.queryLang}"/></td></tr>
</c:forEach>
</table><br><br>
</div> 
                <div class="content">
