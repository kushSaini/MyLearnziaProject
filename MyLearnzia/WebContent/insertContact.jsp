			...
			<div class="bg-contact2"
				...
				<div class="container-contact2">
					<div class="wrap-contact2">
						<form class="contact2-form validate-form"  action="ContactInsertController" method="POST">
						<span class="contact2-form-title"> Insert New Contact </span>
							...
							<label>Enter Contact Name</label>
								...
								<div class="wrap-input2 validate-input" data-validate="Name is required">
                                <input class="input2" type="text" id="name" name="email">
                                <span class="focus-input2" data-placeholder="Enter Contact Email"></span>
                                </div>
                                <label>Enter Designation</label>
								<div class="wrap-input2 validate-input" data-validate="Name is required">
                                <input class="input2" type="text" id="name" name="desg">
                                <span class="focus-input2" data-placeholder="Enter Contact Designation"></span>
                                </div>
                                <div class="container-contact2-form-btn">
						<div class="wrap-contact2-form-btn">
							<div class="contact2-form-bgbtn"></div>
					<button  class="contact2-form-btn" type="submit" id="submit">Submit </button>
					</div>
					</div>
					</form>	
				</div>
