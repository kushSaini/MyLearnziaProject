...
<link href='CalenderDesign/lib/main.css' rel='stylesheet' />
<script src='CalenderDesign/lib/main.js'></script>
<script>
		...
		<div class="sidebar" data-image="DesignData/img/sidebar-5.jpg">
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li><a class="nav-link" href="feedback.html"> <i
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse justify-content-end"
						...
						<ul class="nav navbar-nav mr-auto">
							<span><b>Welcome !! To Calender <%=name %></b></span>
						</ul>
