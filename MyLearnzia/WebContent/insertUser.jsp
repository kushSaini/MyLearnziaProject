				...
				<div class="container-contact2">
					<div class="wrap-contact2">
						<form class="contact2-form validate-form"
							action="UserInsertController" method="POST">
							<span class="contact2-form-title"> User Portal (Create New
								User) </span> <label>Enter Username</label>
							<div class="wrap-input2 validate-input"
								data-validate="Username is required">
								<input class="input2" type="text" id="username" name="username">
								<span class="focus-input2"
									data-placeholder="Enter User's Username"></span>
							</div>
							...
							<div class="wrap-input2 validate-input"
								...
								<span class="focus-input2"
									data-placeholder="Enter User Password"></span>
							</div>
							<label>Enter Name</label>
							<div class="wrap-input2 validate-input"
								data-validate="Name is required">
								<input class="input2" type="text" id="name" name="name">
								<span class="focus-input2" data-placeholder="Enter User's Name"></span>
							</div>
							<label>Enter Date Of Birth (DD-MM-YYYY)</label>
							<div class="wrap-input2 validate-input"
								data-validate="Name is required">
								<input class="input2" type="text" id="dob" name="dob">
								<span class="focus-input2"
									data-placeholder="Enter DOB (DD-MM-YYYY)"></span>
							</div>
							...
							<div class="wrap-input2 validate-input"
								...
								<span class="focus-input2"
									data-placeholder="Enter User's Email"></span>
							</div>
							<label>Enter Mobile No.</label>
							<div class="wrap-input2 validate-input"
								data-validate="Name is required">
								<input class="input2" type="text" id="mobile" name="mobile">
								<span class="focus-input2"
									data-placeholder="Enter User's Mobile No"></span>
							</div>
							...
							<div class="wrap-input2 validate-input"
								...
								<span class="focus-input2"
									data-placeholder="Enter User's Address"></span>
							</div>
							<label>Enter Date Of Joining (DD-MM-YYYY)</label>
							<div class="wrap-input2 validate-input"
								data-validate="Name is required">
								<input class="input2" type="text" id="doj" name="doj">
								<span class="focus-input2"
									data-placeholder="Enter User's Date Of Joining in (DD-MM-YYYY)"></span>
							</div>
							<label>Designation :-</label><br><br>
							<div class="form-check form-check-inline">

								<input class="form-check-input" type="radio"
									name="design" id="design" value="Scholar">
								<label class="form-check-label" for="inlineRadio1">Scholar</label>
							</div>
							<br>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio"
									name="design" id="design" value="Trainer">
								<label class="form-check-label" for="inlineRadio2">Trainer</label>
							</div><br>
							<br> 
							<label>Enter Passcode (if Trainer)</label>
							<div class="wrap-input2 validate-input"
								data-validate="Name is required">
								<input class="input2" type="text" id="passcode" name="passcode">
								<span class="focus-input2"
									data-placeholder="Enter Contact Email"></span>
							</div>
							<div class="container-contact2-form-btn">
								<div class="wrap-contact2-form-btn">
									<div class="contact2-form-bgbtn"></div>
									<button class="contact2-form-btn" type="submit" id="submit">Submit
									</button>
								</div>
							</div>
						</form>
