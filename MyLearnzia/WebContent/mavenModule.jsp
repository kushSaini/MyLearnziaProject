    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="main-panel">
            ...
            <div class="ml-5 mt-5">
                <iframe
                    src="https://docs.google.com/presentation/d/10OPNZnpj0M9jkiOE3wdeP09aMLGb_gdwvLvPIWoc3y4/embed?start=false&loop=false&delayms=3000"
                    frameborder="0" width="960" height="749" allowfullscreen="true" mozallowfullscreen="true"
                    webkitallowfullscreen="true"></iframe>
                    <br><h2><b>Apache Maven</b></h2><hr size="4" color="black">
                <h3>About Maven</h3><br><br>
                <p><b>
                Maven is a project management and comprehension tool that provides developers a complete build lifecycle framework. 
                Development team can automate the project's build infrastructure in almost 
                no time as Maven uses a standard directory layout and a default build lifecycle.<br>
                <br>
                * Simple project setup that follows best practices<br>
				* Consistent usage across all projects.<br>
				* Dependency management including automatic updating.<br>
				* A large and growing repository of libraries.<br>
				* Extensible, with the ability to easily write plugins in Java or scripting languages.
                </b></p><br><br>
                <h4><b>Presentation Credit :</b> Kush Saini,Dia,Sanjukta Ghosh,Rishabh Gupta,Ankit Singh,Himnish Arora :)</h4>
            </div>
            <div class="content">
                <div class="container-fluid">
                    <div class="section">
