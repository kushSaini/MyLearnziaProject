      ...
      <div class="modal-content">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                ...
                <div class="ml-5 mt-5">
                <iframe src="https://docs.google.com/presentation/d/1lRUAn2e4MT90fC-ls0oBzdQN3Kt6bKORJWCBDeR6F_0/embed?start=false&loop=false&delayms=3000" frameborder="0" width="960" height="749" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
                <br><h2><b>GitHub</b></h2><hr size="4" color="black">
                <h3>About GitHub</h3><br><br>
                <p><b>
                ...
                Team members can work on files and easily merge their changes in with the master branch of the project<br>
                <br>
                * Automate your workflows<br>
				* Get alerts about vulnerabilities in your code<br>
				* Seamless code review is the surest path to better code, and it’s fundamental to how GitHub works. Built-in review tools make code review an essential part of your team’s process.
				<br><br>
				* There are hundreds of millions of private, public, and open source repositories hosted on GitHub. 
				Every repository is equipped with tools to help you host, version, and release code and documentation.
				<br><br>
				* Building software is as much about managing teams and communities as it is about code. 
				Whether you’re on a team of two or two thousand, we’ve got the support your people need.
                </b></p><br><br>
                <h4><b>Presentation Credit :</b> Harshul Sharma and Raghavendra Singh Bhati :)</h4>
                </div>
                <div class="content">
                    <div class="container-fluid">
                        <div class="section">
